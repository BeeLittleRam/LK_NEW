...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class Physics2DGetRigidbodyContactsWithColliders : BaseAction
	{
		...
		{
			return CheckParameters(_rigidbody, _contactFilter, _colliders);
		}
		
		public override void Execute()
		{
			//UnityEngine.Physics2D.GetContacts(UnityEngine.Rigidbody2D, UnityEngine.ContactFilter2D, System.Collections.Generic.List`1[[UnityEngine.Collider2D, UnityEngine.Physics2DModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]);
			var resultCount = Physics2D.GetContacts(_rigidbody.Value, _contactFilter.Value, _colliders.Value);
            if (_resultCount.IsAssigned) _resultCount.Value = resultCount;
		}
		
		public override string GetSummary()
		{
			return "Physics2D Get Contacts: {_rigidbody} {_contactFilter} {_colliders} -> {_resultCount}";
		}
	}
}
