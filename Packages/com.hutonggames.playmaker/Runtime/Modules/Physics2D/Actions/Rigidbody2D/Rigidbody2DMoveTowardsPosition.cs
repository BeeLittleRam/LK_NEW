...
namespace HutongGames.PlayMaker.Actions
{
	...
	[ActionDescription("Moves the rigidbody to towards a target world position with optional smoothing and max speed. " +
	...
	public sealed class Rigidbody2DMoveTowardsPosition : BaseAction
	{
		...
		[Tooltip("The world position to move towards.")]
		[SerializeField]
		...
		public override bool CanExecute() => CheckParameters(_rigidbody2D, _position, _maxSpeed);
		...
		public override void Execute()
		{
			...
			_distanceToTarget = Vector2.Distance(position, _position.Value);
		...
		public override string GetSummary() => "Move {_rigidbody2D} towards {_position}" +
