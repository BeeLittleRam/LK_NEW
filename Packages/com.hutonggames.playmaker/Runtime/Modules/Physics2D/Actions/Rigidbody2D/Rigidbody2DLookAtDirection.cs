...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Rotate a Rigidbody2D in 2D (around Z) so a chosen local axis faces a world direction. " +
                       "Includes SmoothTime and MaxSpeed.")]
    [HelpURL("actions/transform-actions/look-at-actions/")]
    public sealed class Rigidbody2DLookAtDirection : BaseAction
    {
        ...
        public override bool CanExecute() => CheckParameters(_rigidbody2D, _direction, _facingAxis);
        ...
        {
            var s = "Rotate {_rigidbody2D} {_facingAxis} to look at {_direction}";
