...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Rotate a Rigidbody2D in 2D (around Z) so a chosen local axis faces a world position. " +
                       "Includes SmoothTime and MaxSpeed.")]
    [HelpURL("actions/transform-actions/look-at-actions/")]
    public sealed class Rigidbody2DLookAtPoint : BaseAction
    {
        ...
        public override bool CanExecute() =>
            CheckParameters(_rigidbody2D, _worldPosition, _facingAxis);
        ...
        {
            var s = "Rotate {_rigidbody2D} {_facingAxis} to look at {_worldPosition}";
