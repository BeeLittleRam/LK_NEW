...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public sealed class InputMouseVirtualJoystick : BaseAction
    {
        ...
        [Tooltip("Speed that the stick recenters towards zero when inside the recenter threshold (units per second). 0 = no spring anywhere.")]
        [SerializeField, DefaultValue(1.5f)]
        private FloatVar _returnRate;

        [Tooltip("Inside this radius, automatic return-to-center activates. Outside it, the stick does not spring. 0 = always spring (no threshold).")]
        ...
        public override void OnStart()
        {
            ...
            {
                Debug.Log("Locking cursor while joystick is active.");
