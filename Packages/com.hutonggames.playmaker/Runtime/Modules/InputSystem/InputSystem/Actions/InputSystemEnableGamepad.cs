...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Enable a gamepad by index (0 = first gamepad).")]
    [HelpURL("actions/input-system-actions/input-devices/")]
    public sealed class InputSystemEnableGamepad : BaseAction
    {
        ...
        public override void Execute()
        {
            ...
            InputSystem.EnableDevice(all[index]);
        }

        public override string GetSummary() => "Enable Gamepad[{_gamepadIndex}]";
    }
}
#endif