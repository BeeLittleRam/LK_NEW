...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HelpURL("https://docs.unity3d.com/ScriptReference/Vector4.LerpUnclamped.html")]
	public sealed class Vector4LerpUnclamped : BaseAction
	{
		...
		{
			_result.Value = Vector4.LerpUnclamped(_a.Value, _b.Value, _t.Value * PerSecond);
		}
