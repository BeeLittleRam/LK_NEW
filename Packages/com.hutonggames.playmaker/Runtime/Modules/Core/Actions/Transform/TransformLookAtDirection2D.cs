...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Rotate a Transform in 2D (around Z) so a chosen local axis faces a world direction. " +
                       "Includes SmoothTime and MaxSpeed.")]
    [HelpURL("actions/transform-actions/look-at-actions/")]
    public sealed class TransformLookAtDirection2D : BaseAction
    {
        ...
        public override bool CanExecute() => CheckParameters(_transform, _direction, _facingAxis);
        ...
        public override void Execute()
        {
            ...
            // 2D preset: constrain to Z, map 2D axis to full AxisDirection
        ...
        {
            var s = "Rotate {_transform} {_facingAxis} to look at {_direction}";
