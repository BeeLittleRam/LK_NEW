...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Clamps a Transform's Y position. By default, this is done in LateUpdate.")]
    [HelpURL("actions/transform-actions/transform-clamp-actions/")]
    public class TransformClampPositionY : BaseAction
    {
        ...
        public override bool CanExecute() => CheckParameters(_transform, _inSpace, _yMin, _yMax);
        ...
        public override string GetSummary() => "Clamp {_transform} Y: {_yMin} to {_yMax} ({_inSpace})";
    }
}