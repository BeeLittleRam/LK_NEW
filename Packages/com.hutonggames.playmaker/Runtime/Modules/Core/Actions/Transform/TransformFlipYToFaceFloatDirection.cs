...
namespace HutongGames.PlayMaker.Actions
{
	...
	[ActionDescription("Set Y axis scale to 1 or -1 to match the sign of a float value. " +
	                   "This is a convenient way to flip sprites to face a movement direction." +
	                   "\n\nSimilar to SpriteRendererFlipYToFaceFloatDirection but scales the whole GameObject hierarchy, " +
	                   "e.g., attach points and sensors.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Transform-localScale.html")]
	public sealed class TransformFlipYToFaceFloatDirection : BaseAction
	{
		...
		public override void Execute()
		{
			...
			scale.y = _direction.Value > 0 ? 1 : -1;
