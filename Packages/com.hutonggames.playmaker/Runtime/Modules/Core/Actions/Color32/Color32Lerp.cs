...
namespace HutongGames.PlayMaker.Actions
{
	...
	[HelpURL("https://docs.unity3d.com/ScriptReference/Color32.Lerp.html")]
	public sealed class Color32Lerp : BaseAction
	{
		...
		{
			_result.Value = Color32.Lerp(_a.Value, _b.Value, _t.Value * PerSecond);
		}
