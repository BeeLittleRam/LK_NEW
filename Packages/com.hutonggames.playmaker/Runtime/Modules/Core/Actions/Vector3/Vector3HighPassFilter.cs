...
namespace HutongGames.PlayMaker.Actions
{
	...
	[ActionDescription("Use a high pass filter to reduce the influence of slow changes in a Vector3 Variable.")]
	public sealed class Vector3HighPassFilter : BaseAction
	{
		...
		private Vector3 _lowPassVector;
		...
		public override void Execute()
		{
			...
			_lowPassVector.z = value.z * _filteringFactor.Value +
			                   _lowPassVector.z * (1.0f - _filteringFactor.Value);
