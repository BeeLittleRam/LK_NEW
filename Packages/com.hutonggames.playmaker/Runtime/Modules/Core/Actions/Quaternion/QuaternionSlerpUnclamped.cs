...
namespace HutongGames.PlayMaker.Actions
{
	...
	[ActionDescription("Spherically linear interpolates between unit quaternions a and b by t.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Quaternion.SlerpUnclamped.html")]
	public sealed class QuaternionSlerpUnclamped : BaseAction
	{
		...
		{
			_result.Value = Quaternion.SlerpUnclamped(_a.Value, _b.Value, _t.Value * PerSecond);
		}
