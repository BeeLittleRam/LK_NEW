...
namespace HutongGames.PlayMaker.Actions
{
	...
	[ActionDescription("Use a low pass filter to reduce the influence of sudden changes in a Vector2 Variable.")]
	public sealed class Vector2LowPassFilter : BaseAction
	{
		...
		private Vector2 _filteredVector;
