...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Clones a GameObject. Optionally set parent, and store the created Object.")]
    [HelpURL("https://docs.unity3d.com/ScriptReference/Object.Instantiate.html")]
    public class GameObjectInstantiate : BaseAction
    {
        ...
        {
            return GameObject.HasValue();
        }

        public override void Execute()
        {
            var created = SetParent.HasValue() 
                ? Object.Instantiate(GameObject.Value, SetParent.Transform, InWorldSpace.Value) 
                : Object.Instantiate(GameObject.Value);
        ...
        public override string GetSummary() => "Instantiate {GameObject} {CreatedObject:output}" 
                                               + (SetParent.IsAssigned ? " parent {SetParent}" : "");
    }
}