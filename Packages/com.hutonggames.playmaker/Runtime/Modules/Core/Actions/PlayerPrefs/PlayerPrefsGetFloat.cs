...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class PlayerPrefsGetFloat : BaseAction
	{
		...
		[SerializeField]
		private FloatVar _defaultValue;
		...
		public override void Execute() => _result.Value = PlayerPrefs.GetFloat(_key.Value, _defaultValue.Value);

		public override string GetSummary() => "Get PlayerPref Float: {_key} -> {_result}" +
