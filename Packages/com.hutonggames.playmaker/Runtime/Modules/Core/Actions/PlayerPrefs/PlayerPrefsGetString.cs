...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class PlayerPrefsGetString : BaseAction
	{
		...
		public override void Execute() => _result.Value = PlayerPrefs.GetString(_key.Value, _defaultValue.Value);

		public override string GetSummary() => "Get PlayerPref String: {_key} -> {_result}" + 
