...
namespace HutongGames.PlayMaker.Actions
{
	...
	[ActionDescription("Linearly interpolates between a and b by t.")]
	[HelpURL("https://docs.unity3d.com/ScriptReference/Mathf.Lerp.html")]
	public sealed class MathfLerp : BaseAction
	{
		...
		{
			_result.Value = Mathf.Lerp(_a.Value, _b.Value, _t.Value * PerSecond);
		}
