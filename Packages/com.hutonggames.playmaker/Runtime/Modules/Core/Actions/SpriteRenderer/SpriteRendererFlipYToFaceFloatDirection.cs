...
namespace HutongGames.PlayMaker.Actions
{
	...
	[ActionDescription("Flips the sprite on the Y axis to match the sign of a float value.")]
	[HelpURL("actions/sprite-actions/sprite-flip-actions/")]
	public sealed class SpriteRendererFlipYToFaceFloatDirection : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_spriteRenderer.Value.flipY = _invert.Value ? _direction.Value > 0 : _direction.Value < 0;
		}
