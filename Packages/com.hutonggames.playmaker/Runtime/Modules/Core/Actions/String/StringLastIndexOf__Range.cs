...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringLastIndexOf__Range : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.LastIndexOf(_value.Value, _startIndex.Value, _count.Value, StringComparison.Ordinal);
		}
		
		public override string GetSummary()
		{
			return "Last Index Of {_string} {_value} {_startIndex} {_count} -> {_result}";
		}
	}
}
