...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringIndexOfAny__StartIndex : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.IndexOfAny(_anyOf.Values, _startIndex.Value);
		}
		
		public override string GetSummary()
		{
			return "Index Of Any {_string} {_anyOf} {_startIndex} -> {_result}";
		}
	}
}
