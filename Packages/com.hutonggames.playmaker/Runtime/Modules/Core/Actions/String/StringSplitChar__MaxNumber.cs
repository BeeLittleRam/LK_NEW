...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringSplitChar__MaxNumber : BaseAction
	{
		...
		[Tooltip("Separator.")]
		[SerializeField]
		private CharVar _separator;
		
		[Tooltip("Max number of strings to generate.")]
		[SerializeField]
		...
		public override void Execute()
		{
			...
			_result.Values = _string.Value.Split(_separator.Value, _count.Value, _options);
		}
