...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringIndexOf__StartIndex : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.IndexOf(_value.Value, _startIndex.Value, StringComparison.Ordinal);
		}
		
		public override string GetSummary()
		{
			return "Index Of {_string} {_value} {_startIndex} -> {_result}";
		}
	}
}
