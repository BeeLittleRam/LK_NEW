...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringLastIndexOfAny__Range : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.LastIndexOfAny(_anyOf.Values, _startIndex.Value, _count.Value);
		}
		
		public override string GetSummary()
		{
			return "Last Index Of Any {_string} {_anyOf} {_startIndex} {_count} -> {_result}";
		}
	}
}
