...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringReplace__Comparison : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.Replace(_oldValue.Value, _newValue.Value, _comparisonType);
		}
		
		public override string GetSummary()
		{
			return "Replace {_string} {_oldValue} {_newValue} {_comparisonType} -> {_result}";
		}
	}
}
