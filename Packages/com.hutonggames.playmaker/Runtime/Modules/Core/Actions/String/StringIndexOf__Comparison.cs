...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringIndexOf__Comparison : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.IndexOf(_value.Value, _startIndex.Value, _comparisonType);
		}
		
		public override string GetSummary()
		{
			return "Index Of {_string} {_value} {_startIndex} {_comparisonType} -> {_result}";
		}
	}
}
