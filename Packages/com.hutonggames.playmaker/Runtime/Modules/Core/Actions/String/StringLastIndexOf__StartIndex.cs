...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringLastIndexOf__StartIndex : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.LastIndexOf(_value.Value, _startIndex.Value, StringComparison.Ordinal);
		}
		
		public override string GetSummary()
		{
			return "Last Index Of {_string} {_value} {_startIndex} -> {_result}";
		}
	}
}
