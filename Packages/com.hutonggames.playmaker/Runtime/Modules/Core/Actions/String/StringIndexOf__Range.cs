...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class StringIndexOf__Range : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _string.Value.IndexOf(_value.Value, _startIndex.Value, _count.Value, StringComparison.Ordinal);
		}
