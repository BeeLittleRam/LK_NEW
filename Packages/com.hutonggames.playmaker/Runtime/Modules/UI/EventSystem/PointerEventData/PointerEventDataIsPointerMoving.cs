...
namespace HutongGames.PlayMaker.Actions.EventSystems
{
	...
	public sealed class PointerEventDataIsPointerMoving : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_result.Value = _pointerEventData.Value.IsPointerMoving();
		}
		
		public override string GetSummary()
		{
			return "Check {_pointerEventData} pointer moving -> {_result}";
		}
	}
}
