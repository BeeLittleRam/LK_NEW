...
namespace HutongGames.PlayMaker.Actions.UI
{
	...
	[ActionDescription("Send an Event when a toggle value changes to true.")]
	[HelpURL("https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/script-Toggle.html")]
	public sealed class ToggleOnToggleOn : BaseAction
	{
		...
		[Tooltip("Send an Event when a toggle value changes to true.")] 
		[SerializeField] 
		...
		public override string GetSummary() => "On {_toggle} on {_sendEvent}";
	}
}
