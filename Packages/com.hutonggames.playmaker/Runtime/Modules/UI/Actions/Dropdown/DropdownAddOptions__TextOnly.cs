...
namespace HutongGames.PlayMaker.Actions.UI
{
	...
	[ActionDescription("Add multiple text-only options to the options of the Dropdown based on a list of strings.")]
	[HelpURL("https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/script-Dropdown.html")]
	public sealed class DropdownAddOptions__TextOnly : BaseAction
	{
