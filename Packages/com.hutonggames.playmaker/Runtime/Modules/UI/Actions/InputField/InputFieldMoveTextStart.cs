...
namespace HutongGames.PlayMaker.Actions.UI
{
	...
	[ActionDescription("Move the caret index to start of text.")]
	[HelpURL("https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/script-InputField.html")]
	public sealed class InputFieldMoveTextStart : BaseAction
	{
		...
		{
			//UnityEngine.UI.InputField.MoveTextStart(System.Boolean);
			_inputField.Value.MoveTextStart(_shift.Value);
		}
		
		public override string GetSummary()
		{
			return "Move {_inputField} text start {_shift}";
		}
	}
}
