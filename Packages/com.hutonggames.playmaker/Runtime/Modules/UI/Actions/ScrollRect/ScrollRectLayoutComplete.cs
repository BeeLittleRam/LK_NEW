...
namespace HutongGames.PlayMaker.Actions.UI
{
	...
	[ActionDescription("See ICanvasElement.LayoutComplete.")]
	[HelpURL("https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/script-ScrollRect.html")]
	public sealed class ScrollRectLayoutComplete : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_scrollRect.Value.LayoutComplete();
		}
		
		public override string GetSummary()
		{
			return "Complete {_scrollRect} layout";
		}
	}
}
*/
