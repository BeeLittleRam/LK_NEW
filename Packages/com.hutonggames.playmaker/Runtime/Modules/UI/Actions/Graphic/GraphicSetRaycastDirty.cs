...
namespace HutongGames.PlayMaker.Actions.UI
{
	...
	[ActionDescription("Indicate that the raycastable area of the UI element needs to be recalculated.")]
	[HelpURL("https://docs.unity3d.com/Packages/com.unity.ugui@2.0/api/UnityEngine.UI.Graphic.html")]
	public sealed class GraphicSetRaycastDirty : BaseAction
	{
		...
		public override void Execute()
		{
			...
			_graphic.Value.SetRaycastDirty();
		}
		
		public override string GetSummary()
		{
			return "Set {_graphic} raycast dirty";
		}
	}
}
