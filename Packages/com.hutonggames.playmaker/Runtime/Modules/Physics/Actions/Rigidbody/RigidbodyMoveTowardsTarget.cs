...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class RigidbodyMoveTowardsTarget : BaseAction
	{
		...
		public override bool CanStart() => CheckParameters(_rigidbody, _target, _maxSpeed);

		public override bool CanExecute() => CheckParameters(_rigidbody, _maxSpeed);
		...
		public override string GetSummary() => "Move {_rigidbody} towards {_target}" +
