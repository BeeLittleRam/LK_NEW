...
{
    [Serializable]
    [DisplayName("Random Position Offscreen")]
    [Tooltip("Generate a random world position outside a camera's view, with optional padding.")]
    public class RandomPositionOffscreenGeneratorBlock : SpawnPositionGeneratorBlock
    {
        ...
        public override void Generate(FindValidRandomPosition action)
        {
            ...
            action.CandidatePosition = OffscreenPositionUtility.GetRandomOffscreenWorldPoint(
                camera,
                PlacementMode,
                ZPlane.Value,
                Padding.Value);
        ...
        public override string GetSummary() => "Random offscreen position";
    }
}
