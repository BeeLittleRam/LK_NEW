...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class ListIndexOf__Range : BaseAction
    {
        ...
        public override void Execute() => GetIndex.Value = List.ListVariable.IndexOf(Item.GetValue(), StartIndex.Value, Count.Value);

        public override string GetSummary() => "Get index of {Item} in {List} from {StartIndex} count {Count} -> {GetIndex}";
    }
}
