...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Get a data field value from a Data Component on a GameObject.")]
    [HelpURL("actions/data-actions/game-object/game-object-get-data-field/")]
    public sealed class GameObjectGetDataField : BaseAction
    {
        ...
        [Tooltip("If no matching Data Component is found, store the DataDefinition's default values into outputs instead.")]
        public BoolVar StoreDefaultsIfMissing;
        
        [Tooltip("Get the field's values from the Data Component. ")]
        public DataFieldStore GetValue = new();
        ...
        public override void Execute()
        {
            ...
            DataRowUtility.ApplyStore(row, GetValue);
        ...
        public override string GetSummary() =>
            "Get <b>" +
            GetValue.GetFieldName(DataDefinition) + 
            "</b> on {GameObject} {GetValue.Store:output}";
    }
}
