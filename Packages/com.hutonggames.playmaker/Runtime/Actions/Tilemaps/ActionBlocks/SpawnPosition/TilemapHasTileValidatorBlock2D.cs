...
{
    [Serializable]
    [DisplayName("Tilemap Has Tile 2D")]
    [Tooltip("Require the candidate position to map to a Tilemap cell that contains a tile.")]
    public class TilemapHasTileValidatorBlock2D : SpawnPositionValidatorBlock2D
    {
        ...
        public override string GetSummary() => "{Tilemap} has tile";
    }
}
