...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class TweenRectTransformAnchoredPosition : BaseTweenAction
    {
        ...
        public override void OnStart()
        {
            ...
            {
                _fromValue = _rectTransform.Value.anchoredPosition;
                _toValue = _position.Value;
            }
            else
            {
                _fromValue = _position.Value;
                _toValue = _rectTransform.Value.anchoredPosition;
            }
        ...
        public override void Execute()
        {
            ...
            _rectTransform.Value.anchoredPosition = Vector2.Lerp(_fromValue, _toValue, Easing.Evaluate(Progress));
        }
