...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Insert an item into an AnimatedListWidget. Optionally stores the created item.")]
    [HelpURL("guides/ui-widgets/lists/animated-list/")]
    public class AnimatedListInsertItem : BaseAction
    {
        ...
        public override void Execute()
        {
            ...
            var created = animatedList.InsertItem(_atIndex.Value, prefab, settings);
        ...
        public override string GetSummary()
        {
            return "Insert " +
                   ...
                   " into {_animatedList} at {_atIndex} -> {_storeItem}";
        }
