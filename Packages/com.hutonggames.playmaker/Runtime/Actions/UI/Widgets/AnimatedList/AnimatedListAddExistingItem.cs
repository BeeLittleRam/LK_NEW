...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Add an existing item instance to an AnimatedListWidget (adopts it into the list and animates it in).")]
    [HelpURL("guides/ui-widgets/lists/animated-list/")]
    public class AnimatedListAddExistingItem : BaseAction
    {
        ...
        public override void Execute()
        {
            ...
            animatedList.AddExistingItem(itemGo, settings);
        ...
        {
            return "Add existing {_item} to {_animatedList}";
        }
