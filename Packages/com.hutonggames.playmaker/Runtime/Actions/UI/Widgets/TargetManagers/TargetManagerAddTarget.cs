...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Add a target to a TargetManager component (e.g. OffscreenIndicator, TargetIndicator, Radar...)")]
    [HelpURL("guides/ui-widgets/target-managers")]
    public sealed class TargetManagerAddTarget : BaseAction
    {
        [Tooltip("The TargetManager component.")]
        [SerializeField]
        private BaseTargetManagerVar _manager;
        
        [Tooltip("GameObject target to track.")]
        [SerializeField]
        ...
        public override string GetSummary() => "Add {_target} to {_manager}";
    }
}