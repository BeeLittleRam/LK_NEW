...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Get the closest Transform in a Transform List to a target.")]
    public sealed class TransformListGetClosest : BaseAction
    {
        ...
        [Tooltip("Store the closest Transform.")]
        public TransformRef StoreResult;

        [OptionalField, WriteOnly]
        [Tooltip("Store the zero-based index of the closest Transform.")]
        public IntegerRef StoreIndex;

        [OptionalField, WriteOnly]
        [Tooltip("Store the distance to the closest Transform.")]
        ...
        public override string GetSummary()
        {
            ...
            return $"Get closest Transform from {{Transforms}} to {{Target}}{axis} -> {{StoreResult:output}} {{StoreIndex:output}} {{StoreDistance:output}} {{Found:output}}";
        }
