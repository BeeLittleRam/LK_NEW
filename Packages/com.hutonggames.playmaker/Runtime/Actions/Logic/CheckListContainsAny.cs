...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionDescription("Checks if a list contains any of the given items. Sends Events based on the result.")]
    [HelpURL("https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1.contains")]
    public class CheckListContainsAny : BaseTrueFalseAction
    {
        ...
        protected override string TrueSummary => "{List} contains any {Items}";
        protected override string FalseSummary => "{List} does not contain any {Items}";
    }
}