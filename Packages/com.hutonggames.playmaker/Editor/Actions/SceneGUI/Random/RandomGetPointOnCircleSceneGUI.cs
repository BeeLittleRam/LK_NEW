...
{
    [PublicAPI]
    [SceneGUI(typeof(RandomGetPointOnCircle))]
    public class RandomGetPointOnCircleSceneGUI : SceneGUIDrawer
    {
        private RandomGetPointOnCircle _action;

        public RandomGetPointOnCircleSceneGUI(RandomGetPointOnCircle target) : base(target)
        {
            _action = target;
        }
