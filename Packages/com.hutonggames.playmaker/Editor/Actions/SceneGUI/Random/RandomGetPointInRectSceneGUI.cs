...
{
    [PublicAPI]
    [SceneGUI(typeof(RandomGetPointInRect))]
    public class RandomGetPointInRectSceneGUI : SceneGUIDrawer
    {
        private RandomGetPointInRect _action;

        public RandomGetPointInRectSceneGUI(RandomGetPointInRect target) : base(target)
        {
            _action = target;
        }
