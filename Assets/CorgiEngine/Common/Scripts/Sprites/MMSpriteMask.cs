...
namespace MoreMountains.CorgiEngine
{
	...
	public class MMSpriteMask : CorgiMonoBehaviour, MMEventListener<MMSpriteMaskEvent>
	{
		...
		protected virtual void SetupMaskSettingsAutomatically()
		{
			...
			{
				SpriteRenderer[] foundSpriteRenderers = FindObjectsByType<SpriteRenderer>();
			...
			{
				TilemapRenderer[] foundTilemapRenderers = FindObjectsByType<TilemapRenderer>();
			...
			{
				ParticleSystem[] foundParticleSystems = FindObjectsByType<ParticleSystem>();
