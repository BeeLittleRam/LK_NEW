...
namespace MoreMountains.CorgiEngine
{
	...
	public class CharacterInventory : CharacterAbility, MMEventListener<MMInventoryEvent>, MMEventListener<CorgiEngineEvent>
	{
		...
		protected virtual void GrabInventories()
		{
			...
			{
				MainInventory = Inventory.FindInventory(MainInventoryName, PlayerID);
			}
			if (WeaponInventory == null)
			{
				WeaponInventory = Inventory.FindInventory(WeaponInventoryName, PlayerID);
			}
			if (HotbarInventory == null)
			{
				HotbarInventory = Inventory.FindInventory(HotbarInventoryName, PlayerID);
			}
