...
{	
	...
	public class CharacterHandleWeapon : CharacterAbility 
	{
		...
		/// if this is true, the weapon will be unequiped on death
		[Tooltip("if this is true, the weapon will be unequiped on death")]
		public bool UnequipWeaponOnDeath = false;
		...
		protected override void OnDeath()
		{
			base.OnDeath();
			ShootStop();
			if (UnequipWeaponOnDeath && (CurrentWeapon != null))
			{
