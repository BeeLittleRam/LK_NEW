...
namespace MoreMountains.CorgiEngine
{
	...
	public class StartScreen : CorgiMonoBehaviour
	{
		...
		[Header("Input")]
		#if ENABLE_INPUT_SYSTEM && !ENABLE_LEGACY_INPUT_MANAGER
		/// the key to press to skip the start screen (new Input System)
		[Tooltip("the key to press to skip the start screen")]
		public Key SkipKey = Key.Space;
		#else
		/// the name of the Input Manager button to press to skip the start screen
		[Tooltip("the name of the Input Manager button to press to skip the start screen")]
		public string SkipButtonName = "Player1_Jump";
		#endif
		...
		/// <summary>
		/// During update we simply wait for the user to press the skip button.
		/// </summary>
