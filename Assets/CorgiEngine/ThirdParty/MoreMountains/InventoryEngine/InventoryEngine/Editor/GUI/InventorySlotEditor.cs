...
namespace MoreMountains.InventoryEngine
{
	...
	public class InventorySlotEditor : UnityEditor.UI.ButtonEditor 
	{
		...
		protected SerializedProperty _quantityTextTMP;
		...
		protected override void OnEnable()
		{
			...
			#if MM_UGUI2
				_quantityTextTMP = serializedObject.FindProperty("QuantityTextTMP");
			#endif
		}
		...
		public override void OnInspectorGUI() {
			...
			#if MM_UGUI2
				EditorGUILayout.PropertyField(_quantityTextTMP);
			#endif
